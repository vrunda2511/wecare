            ...
            <div className="container bottom_border">
                <div className="row">
                    <div className=" col-sm-4 col-md col-sm-4  col-12 col">
                        ...
                        <p><CallIcon style={{ color: "#ffe484", marginRight: 5, marginBottom: 5 }}></CallIcon>+91-9426553286  </p>
                        <p><MailIcon style={{ color: "#ffe484", marginRight: 5, marginBottom: 5 }}></MailIcon>harshilsheth181888@gmail.com  </p>
